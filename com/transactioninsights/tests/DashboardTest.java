...
public class DashboardTest extends BaseTest {
    ...
    public void testDashboardLoadsWithTitleAndTable() {
        ...
        if (rowCount == 0) {
            logWarning("No rows in transaction table. Skipping test due to backend data state.");
            throw new SkipException("Skipping test because transaction table has no data rows.");
        }
