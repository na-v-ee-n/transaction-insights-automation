...
Summary:
Added a new test case TC_017 named testPageTitle to verify the page title is "Transaction Insights Dashbaord". Included proper logging steps and assertions to ensure the title matches exactly.
